    ...
    return (
        <>
                <nav className='fixed bg-white/90 w-full flex justify-between item-center px-20 border-b-2 z-20'>
                    <div className="logo">
                        <h1 className='h-full flex item-center justify-center text-4xl font-bold p-4'>TRAVITY</h1>
                    </div>
                ...
                <div className="signup___signin flex justify-center items-center p-2 cursor-pointer">
