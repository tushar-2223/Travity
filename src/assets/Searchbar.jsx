...
export const Searchbar = () => {
    return (
        <>
            <div className='bg-white/90 mx-40 border-2 rounded-xl p-5 flex flex-col'>
                <div className='flex flex-wrap justify-evenly'>
                    <div className='flex flex-col p-2'>
                        <label htmlFor="From" className='my-2 font-bold text-[18px] text-blue'>From</label>
                        <input className='p-2 outline-none border-2 rounded-xl w-60' name='From' type="text" />
                    </div>

                    <div className='flex flex-col p-2'>
                        <label htmlFor="Destination" className='my-2 font-bold text-[18px] text-blue'>Destination</label>
                        <input className='p-2 outline-none border-2 rounded-xl w-60' name='Destination' type="text" />
                    </div>

                    <div className='flex flex-col p-2'>
                        <label htmlFor="Guest" className='my-2 font-bold text-[18px] text-blue'>Guest</label>
                    ...
                    <div className='flex flex-col p-2'>
                        <label htmlFor="From" className='my-2 font-bold text-[18px] text-blue'>Start Date</label>
                        <input className='p-2 outline-none border-2 rounded-xl w-60' name='sdate' type="date" />
                    </div>

                    <div className='flex flex-col p-2'>
                        <label htmlFor="From" className='my-2 font-bold text-[18px] text-blue'>End Date</label>
